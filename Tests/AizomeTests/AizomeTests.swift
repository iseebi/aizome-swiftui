...
struct AizomeTests {
    ...
    @MainActor @Test func testStyle_blueAndBold() throws {
        let result = styledString("<blue>Hello</blue> <bold12>World</bold12>", styles: definitions)
    ...
    @MainActor @Test func testStyle_nestedBlueBold() throws {
        let result = styledString("<blue><bold12>Hello</bold12></blue> <bold12>World</bold12>", styles: definitions)
        try assertStyle(result, substring: "Hello", expectedFont: .system(size: 12, weight: .bold), expectedColor: .blue)
        try assertStyle(result, substring: "World", expectedFont: .system(size: 12, weight: .bold))
    }

    @MainActor @Test func testStyle_redAndBold() throws {
        let result = styledString("<red><bold12>Hello</bold12></red> <bold12>World</bold12>", styles: definitions)
        try assertStyle(result, substring: "Hello", expectedFont: .system(size: 12, weight: .bold), expectedColor: .red)
        try assertStyle(result, substring: "World", expectedFont: .system(size: 12, weight: .bold))
    }

    @MainActor @Test func testStyle_nestedNormalInBold() throws {
        let result = styledString("<red><bold12>Hello world <normal14>Aizome</normal14></bold12></red>", styles: definitions)
    ...
    @MainActor @Test func testStyle_unknownInnerTag() throws {
        let result = styledString("<blue><bold12><unknown>Hello</unknown></bold12></blue> <bold12>World</bold12>", styles: definitions)
        try assertStyle(result, substring: "Hello", expectedFont: .system(size: 12, weight: .bold), expectedColor: .blue)
        try assertStyle(result, substring: "World", expectedFont: .system(size: 12, weight: .bold))
    }
}
