...
extension Parser {
    func parseParameterStrings(_ segments: [ParserSegment]) -> [ParserSegment] {
        ...
        for segment in segments {
            ...
            case .text(let text, let styles):
                ...
                while i < text.endIndex {
                    ...
                    result.append(.placeholder(format: formatWithoutIndex, raw: formatText, index: resolvedIndex, styles: styles))
                    i = formatRange.upperBound
                }
            case .placeholder:
